        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              <li class="nav-item active"><a class="nav-link" href="view_register.php">Home</a></li>
                           <li class="nav-item"><a class="nav-link" href="view_register.php">Register</a></li>
              <li class="nav-item"><a class="nav-link" href="view_contact.php">Contact</a></li>
              <li class="nav-item"><a class="nav-link" href="view_product.php">Product</a></li>
							
                 <li class="nav-item"><a class="nav-link" href="add_category.php">Category</a></li>
