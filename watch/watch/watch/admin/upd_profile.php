...
if(isset($_POST["update"]))
	{
		...
		$qt="UPDATE registration SET  FIRSTNAME='$fnm',LASTNAME='$lnm',BDATE='$bdate',GENDAR='$gen',ADDRESS='$add',CITY='$cit',STATE='$ste',COUNTRY='$cou',CONTACT='$con1',PINCODE='$pin' WHERE MAIL='".$_SESSION['un']."'";
		$sql=mysqli_query($con,$qt);
		//header("Location:view_registration.php");	


	}

$result = mysqli_query($con,"SELECT * FROM registration WHERE MAIL='".$_SESSION['un']."'");
	...
	<section class="login_box_area section-margin">
		<div class="container">
			<div class="row">
              ...
              <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="Gender" name="GENDAR" placeholder="Gender" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Gender'" value="<?php echo $row['GENDAR']; ?>">
              </div>
              <div class="col-md-12 form-group">
              ...
              <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="contect" name="CONTACT" placeholder="contect" onfocus="this.placeholder = ''" onblur="this.placeholder = 'contect'" value="<?php echo $row['CONTACT']; ?>">
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<input type="hidden" class="form-control" id="email" name="MAIL" placeholder="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'email'">
							</div>
